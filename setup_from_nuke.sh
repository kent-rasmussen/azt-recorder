...
echo "Then run:       python compile_translations.py && buildozer android debug"
echo ""
echo "compile_translations.py keeps locales/<lang>/LC_MESSAGES/aztrecorder.mo"
echo "in sync with the .po — the .mo is what the APK actually ships, and the"
echo "runtime ensure_mo helper has been observed to silently skip on Android"
echo "when APK extraction gives the .po and .mo matching mtimes."
